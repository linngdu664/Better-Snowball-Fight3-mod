...
public class SpectralSnowballItem extends AbstractBSFSnowballItem {
    public SpectralSnowballItem() {
        super(Rarity.UNCOMMON, new SnowballProperties().idForTank(9).allowLaunchTypeFlag(AbstractBSFSnowballItem.HAND_TYPE_FLAG | SnowballCannonItem.TYPE_FLAG | SnowballShotgunItem.TYPE_FLAG | SnowballMachineGunItem.TYPE_FLAG));
...
//    }
    ...
    public void addLastTips(List<Component> pTooltipComponents) {
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("spectral_snowball.tooltip", null, new Object[0])).withStyle(ChatFormatting.GRAY));
    }
}
