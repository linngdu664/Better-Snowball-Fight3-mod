...
public class ThrustSnowballItem extends AbstractBSFSnowballItem {
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, @NotNull TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("thrust_snowball1.tooltip")).withStyle(ChatFormatting.BLUE));
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("thrust_snowball2.tooltip")).withStyle(ChatFormatting.BLUE));
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("thrust_snowball.tooltip")).withStyle(ChatFormatting.DARK_AQUA));
    }
}
