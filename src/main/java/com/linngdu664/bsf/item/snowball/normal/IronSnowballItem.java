...
public class IronSnowballItem extends AbstractBSFSnowballItem {
    ...
    public int getTypeFlag() {
        return SnowballCannonItem.TYPE_FLAG | SnowballShotgunItem.TYPE_FLAG | SnowballMachineGunItem.TYPE_FLAG | TargetLocatorItem.TYPE_FLAG;
    }

    @Override
    public Item getTank() {
        return ItemRegister.IRON_SNOWBALL_TANK.get();
    }
