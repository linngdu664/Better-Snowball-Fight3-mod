...
public class LightPlayerTrackingSnowballTank extends AbstractSnowballTankItem {
    public LightPlayerTrackingSnowballTank() {
        super(ItemRegister.LIGHT_PLAYER_TRACKING_SNOWBALL.get());
    }
