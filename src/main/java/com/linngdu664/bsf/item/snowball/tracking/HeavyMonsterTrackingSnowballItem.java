...
public class HeavyMonsterTrackingSnowballItem extends AbstractBSFSnowballItem {
    ...
    public BSFSnowballEntity getCorrespondingEntity(Level level, LivingEntity livingEntity, LaunchFunc launchFunc) {
        return new HeavyMonsterTrackingSnowballEntity(livingEntity, level, launchFunc);
    }
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, @NotNull TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("HMT_snowball.tooltip")).withStyle(ChatFormatting.GOLD));
    }
}
