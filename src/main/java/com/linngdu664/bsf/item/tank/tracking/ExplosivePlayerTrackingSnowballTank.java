...
public class ExplosivePlayerTrackingSnowballTank extends AbstractSnowballTankItem {
    public ExplosivePlayerTrackingSnowballTank() {
        super(ItemRegister.EXPLOSIVE_PLAYER_TRACKING_SNOWBALL.get());
    }
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, @NotNull TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("EPT_snowball.tooltip")).withStyle(ChatFormatting.GOLD));
    }
}
