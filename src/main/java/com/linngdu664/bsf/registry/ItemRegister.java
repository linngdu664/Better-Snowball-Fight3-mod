...
public class ItemRegister {
    ...
    public static final RegistryObject<Item> THRUST_GOLEM_CORE = ITEMS.register("thrust_golem_core", () -> new SnowGolemCoreItem(Rarity.UNCOMMON, 120, new String[]{"thrust_golem_core.tooltip","thrust_golem_core_cd.tooltip"}, new ChatFormatting[]{ChatFormatting.BLUE,ChatFormatting.GRAY}));
    public static final RegistryObject<Item> SWIFTNESS_GOLEM_CORE = ITEMS.register("swiftness_golem_core", () -> new SnowGolemCoreItem(Rarity.UNCOMMON, 0, new String[]{"swiftness_golem_core.tooltip","swiftness_golem_core_cd.tooltip"}, new ChatFormatting[]{ChatFormatting.BLUE,ChatFormatting.GRAY}));
    public static final RegistryObject<Item> REGENERATION_GOLEM_CORE = ITEMS.register("regeneration_golem_core", () -> new SnowGolemCoreItem(Rarity.UNCOMMON, 100, new String[]{"regeneration_golem_core.tooltip","regeneration_golem_core_cd.tooltip"}, new ChatFormatting[]{ChatFormatting.BLUE,ChatFormatting.GRAY}));
    public static final RegistryObject<Item> CRITICAL_SNOW_GOLEM_CORE = ITEMS.register("critical_snow_golem_core", () -> new SnowGolemCoreItem(Rarity.UNCOMMON, 0, new String[]{"critical_snow_golem_core.tooltip","critical_snow_golem_core_cd.tooltip"}, new ChatFormatting[]{ChatFormatting.BLUE,ChatFormatting.GRAY}));
    public static final RegistryObject<Item> REPULSIVE_FIELD_GOLEM_CORE = ITEMS.register("repulsive_field_golem_core", () -> new SnowGolemCoreItem(Rarity.UNCOMMON, 100, new String[]{"repulsive_field_golem_core.tooltip","repulsive_field_golem_core_cd.tooltip"}, new ChatFormatting[]{ChatFormatting.BLUE,ChatFormatting.GRAY}));
    public static final RegistryObject<Item> NEAR_TELEPORTATION_GOLEM_CORE = ITEMS.register("near_teleportation_golem_core", () -> new SnowGolemCoreItem(Rarity.RARE, 160, new String[]{"near_teleportation_golem_core.tooltip","near_teleportation_golem_core_cd.tooltip"}, new ChatFormatting[]{ChatFormatting.BLUE,ChatFormatting.GRAY}));
    public static final RegistryObject<Item> ENDER_TELEPORTATION_GOLEM_CORE = ITEMS.register("ender_teleportation_golem_core", () -> new SnowGolemCoreItem(Rarity.RARE, 200, new String[]{"ender_teleportation_golem_core.tooltip","ender_teleportation_golem_core_cd.tooltip"}, new ChatFormatting[]{ChatFormatting.BLUE,ChatFormatting.GRAY}));
    public static final RegistryObject<Item> ACTIVE_TELEPORTATION_GOLEM_CORE = ITEMS.register("active_teleportation_golem_core", () -> new SnowGolemCoreItem(Rarity.RARE, 240, new String[]{"active_teleportation_golem_core.tooltip","active_teleportation_golem_core_cd.tooltip"}, new ChatFormatting[]{ChatFormatting.BLUE,ChatFormatting.GRAY}));
