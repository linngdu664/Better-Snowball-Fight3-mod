...
public class HeavyPlayerTrackingSnowballItem extends AbstractBSFSnowballItem {
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(@NotNull Level pLevel, Player pPlayer, @NotNull InteractionHand pUsedHand) {
        ...
        if (pPlayer.isShiftKeyDown()) {
            ...
            storageInTank(pPlayer, itemStack, ItemRegister.HEAVY_PLAYER_TRACKING_SNOWBALL_TANK.get());
        }
    ...
    public BSFSnowballEntity getCorrespondingEntity(Level level, LivingEntity livingEntity, LaunchFunc launchFunc) {
        return new HeavyPlayerTrackingSnowballEntity(livingEntity, level, launchFunc);
    }
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, @NotNull TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("HPT_snowball.tooltip", null, new Object[0])).withStyle(ChatFormatting.GOLD));
    }
}
