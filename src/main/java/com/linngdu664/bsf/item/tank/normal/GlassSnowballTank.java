...
public class GlassSnowballTank extends AbstractSnowballTankItem {
    public GlassSnowballTank() {
        super(ItemRegister.GLASS_SNOWBALL.get());
    }
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, @NotNull TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("glass_snowball.tooltip")).withStyle(ChatFormatting.DARK_AQUA));
    }
}
