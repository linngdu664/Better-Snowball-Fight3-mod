...
public class SpectralSnowballTank extends AbstractSnowballTankItem {
    public SpectralSnowballTank() {
        super(ItemRegister.SPECTRAL_SNOWBALL.get());
    }
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, @NotNull TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("spectral_snowball.tooltip", null, new Object[0])).withStyle(ChatFormatting.DARK_AQUA));
    }
}
