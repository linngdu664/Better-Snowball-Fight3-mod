...
public class IronSnowballTank extends AbstractSnowballTankItem {
    public IronSnowballTank() {
        super(ItemRegister.IRON_SNOWBALL.get());
    }
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, @NotNull TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("iron_snowball.tooltip")).withStyle(ChatFormatting.DARK_AQUA));
    }
}
