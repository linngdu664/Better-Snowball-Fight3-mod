...
public class EntityRegister {
    ...
    public static final RegistryObject<EntityType<AbstractFixedForceExecutor>> MONSTER_GRAVITY_EXECUTOR = executorRegister(MonsterGravityExecutor::new, "monster_gravity_executor", 0.25F);
    public static final RegistryObject<EntityType<AbstractFixedForceExecutor>> MONSTER_REPULSION_EXECUTOR = executorRegister(MonsterRepulsionExecutor::new, "monster_repulsion_executor", 0.25F);
    public static final RegistryObject<EntityType<AbstractFixedForceExecutor>> PROJECTILE_GRAVITY_EXECUTOR = executorRegister(ProjectileGravityExecutor::new, "projectile_gravity_executor", 0.25F);
    public static final RegistryObject<EntityType<AbstractFixedForceExecutor>> PROJECTILE_REPULSION_EXECUTOR = executorRegister(ProjectileRepulsionExecutor::new, "projectile_repulsion_executor", 0.25F);
    ...
    public static final RegistryObject<EntityType<PowderExecutor>> POWDER_EXECUTOR = executorRegister(PowderExecutor::new, "powder_executor", 0.25F);
