...
public class BlockEntityRegister {
    ...
    public static final RegistryObject<BlockEntityType<CriticalSnowBlockEntity>> CRITICAL_SNOW_BLOCK_ENTITY = BLOCK_ENTITIES.register("critical_snow_block_entity", () -> BlockEntityType.Builder.of(CriticalSnowBlockEntity::new, BlockRegister.CRITICAL_SNOW_BLOCK.get()).build(null));
}
