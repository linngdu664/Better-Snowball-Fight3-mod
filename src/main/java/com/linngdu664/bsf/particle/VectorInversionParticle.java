...
public class VectorInversionParticle extends TextureSheetParticle {
    ...
    protected VectorInversionParticle(ClientLevel pLevel, double pX, double pY, double pZ, double p0X, double p0Z, double speed, float r, float g, float b, SpriteSet pSprites) {
        ...
        this.polarPos2d = new PolarPos2d(new Vec2((float) p0X, (float) p0Z), new Vec2((float) pX, (float) pZ));
    ...
    public void tick() {
        ...
        if (this.age++ >= this.lifetime) {
            ...
            Vec2 vec2 = polarPos2d.rotateLength(speed);
            this.move(vec2.x, 0, vec2.y);
    ...
    public static class ProviderRed implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            float f = pLevel.random.nextFloat() * 0.6F + 0.4F;
