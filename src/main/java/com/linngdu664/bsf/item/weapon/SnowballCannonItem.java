...
public class SnowballCannonItem extends AbstractBSFWeaponItem {
            ...
            if (f >= 0.1F) {
                ...
                if (itemStack != null) {
                    ...
                    if (pLevel.isClientSide()) {
                        ...
                        NetworkRegister.PACKET_HANDLER.send(PacketDistributor.TRACKING_ENTITY_AND_SELF.with(() -> player), new ForwardConeParticlesToClient(player.getEyePosition(), cameraVec, 4.5F, 90, 1.5F, 0.1));
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(@NotNull Level pLevel, Player pPlayer, @NotNull InteractionHand pHand) {
        ...
        if (EnchantmentHelper.getItemEnchantmentLevel(EnchantmentRegister.SNOW_GOLEM_EXCLUSIVE.get(), itemStack) <= 0 && !pPlayer.hasEffect(EffectRegister.WEAPON_JAM.get())) {
