...
public class BlackHoleSnowballItem extends AbstractBSFSnowballItem {
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, @NotNull TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("black_hole_snowball1.tooltip")).withStyle(ChatFormatting.BLUE));
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("black_hole_snowball.tooltip")).withStyle(ChatFormatting.OBFUSCATED));
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("black_hole_snowball.tooltip")).withStyle(ChatFormatting.DARK_PURPLE));
    }
}
