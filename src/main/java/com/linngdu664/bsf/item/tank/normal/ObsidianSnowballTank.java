...
public class ObsidianSnowballTank extends AbstractSnowballTankItem {
    public ObsidianSnowballTank() {
        super(ItemRegister.OBSIDIAN_SNOWBALL.get());
    }
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, @NotNull TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("obsidian_snowball.tooltip")).withStyle(ChatFormatting.DARK_AQUA));
    }
}
