...
public class SoundRegister {
    ...
    public static final RegistryObject<SoundEvent> IMPULSE = build("memesound01");
...
//        return SOUNDS.register(id, () -> new SoundEvent(new ResourceLocation(Main.MODID, id), range));
//    }

    private static RegistryObject<SoundEvent> build(String id) {
        return SOUNDS.register(id, () -> new SoundEvent(new ResourceLocation(Main.MODID, id)));
    }
