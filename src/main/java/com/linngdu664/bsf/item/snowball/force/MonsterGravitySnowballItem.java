...
public class MonsterGravitySnowballItem extends AbstractBSFSnowballItem {
    ...
    @Override
    public Item getTank() {
        return ItemRegister.MONSTER_GRAVITY_SNOWBALL_TANK.get();
    }
...
//        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("monster_gravity_snowball.tooltip", null, new Object[0])).withStyle(ChatFormatting.DARK_PURPLE));
//    }
