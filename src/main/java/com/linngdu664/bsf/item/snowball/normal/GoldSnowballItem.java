...
//    }
    ...
    public void addLastTips(List<Component> pTooltipComponents) {
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("gold_snowball.tooltip", null, new Object[0])).withStyle(ChatFormatting.GRAY));
    }
}
