...
public class ProjectileGravitySnowballTank extends AbstractSnowballTankItem {
    public ProjectileGravitySnowballTank() {
        super(ItemRegister.PROJECTILE_GRAVITY_SNOWBALL.get());
    }
