...
public class PowderSnowballTank extends AbstractSnowballTankItem {
    public PowderSnowballTank() {
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, @NotNull TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("powder_snowball.tooltip")).withStyle(ChatFormatting.DARK_AQUA));
    }
