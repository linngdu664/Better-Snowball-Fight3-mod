...
public class CriticalFrozenSnowballItem extends AbstractBSFSnowballItem {
    ...
    public AbstractBSFSnowballEntity getCorrespondingEntity(Level level, LivingEntity livingEntity, ILaunchAdjustment launchAdjustment) {
        return new CriticalFrozenSnowballEntity(livingEntity, level, launchAdjustment);
    }
    ...
    public void addLastTips(List<Component> pTooltipComponents) {
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("critical_frozen_snowball.tooltip", null, new Object[0])).withStyle(ChatFormatting.GRAY));
    }
}
