...
public class SubspaceSnowballReleaseTraceParticle extends TextureSheetParticle {
    ...
    protected SubspaceSnowballReleaseTraceParticle(ClientLevel pLevel, double pX, double pY, double pZ, double p0X, double p0Y, double p0Z, float r, float g, float b, double speed, SpriteSet pSprites) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            ...
            return new SubspaceSnowballReleaseTraceParticle(pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed, (float) color.getRed() /255,(float) color.getGreen() /255,(float) color.getBlue() /255,BSFCommonUtil.randDoubleWithInfer(random,1,5), this.sprite);
        }
    }
