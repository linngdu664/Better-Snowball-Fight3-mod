...
public class ExplosiveMonsterTrackingSnowballTank extends AbstractSnowballTankItem {
    public ExplosiveMonsterTrackingSnowballTank() {
        super(ItemRegister.EXPLOSIVE_MONSTER_TRACKING_SNOWBALL.get());
    }
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, @NotNull TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("EMT_snowball.tooltip")).withStyle(ChatFormatting.GOLD));
    }
}
