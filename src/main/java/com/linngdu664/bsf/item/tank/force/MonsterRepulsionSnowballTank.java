...
public class MonsterRepulsionSnowballTank extends AbstractSnowballTankItem {
    public MonsterRepulsionSnowballTank() {
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, @NotNull TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("monster_repulsion_snowball.tooltip")).withStyle(ChatFormatting.DARK_PURPLE));
    }
}
