...
public class ExplosiveSnowballTank extends AbstractSnowballTankItem {
    public ExplosiveSnowballTank() {
        super(ItemRegister.EXPLOSIVE_SNOWBALL.get());
    }
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, @NotNull TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(MutableComponent.create(new TranslatableContents("explosive_snowball.tooltip")).withStyle(ChatFormatting.DARK_AQUA));
    }
}
